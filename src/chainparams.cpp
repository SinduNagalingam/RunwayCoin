...
{
    const char* pszTimestamp = "BBC 10/Aug/2018 Standoff over china mosque demolition";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1533903801, 2084977078, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x45a9522faa47967e8a31dbb43771c0f393d8ded9e071d266955893b7076de067"));
        assert(genesis.hashMerkleRoot == uint256S("0x9a32c3da64462ed7365263a4beab4a85e699f9dd7b09e27f36e82fe42a09d34e"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("167.99.158.64:62458",true);
        vSeeds.emplace_back("18.216.97.8:62458",true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.runwaycointools.com");
        vSeeds.emplace_back("seed-b.runwaycoin.loshan.co.uk");
