...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s runwaycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  runwaycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded runwaycoin transaction") + "\n" +
              "  runwaycoin-tx [options] -create [commands]   " + _("Create hex-encoded runwaycoin transaction") + "\n" +
              "\n";
