...
#if defined(NDEBUG)
# error "runwaycoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "runwaycoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s RWC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("runwaycoin-scriptch");
